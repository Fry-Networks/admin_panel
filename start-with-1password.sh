#!/usr/bin/env bash
# Wrapper script to start the admin panel with secrets sourced from 1Password.
set -euo pipefail
...
# Attempt to hydrate OP_SERVICE_ACCOUNT_TOKEN from 1Password if it isn't set.
...
echo "Secrets loaded successfully. Starting Next.js via npm start..."
exec npm start
