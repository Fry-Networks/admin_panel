...
interface ProductData {
  ...
  stakeAmountHigh?: string;
  stakeAmountLow: string;
  password: string;
}
...
export default async function handler(
  ...
  if (req.method === 'PUT') {
    ...
    try {
      ...
      if (stakeAmountHigh !== undefined)
        updateData['reward.stake.stake_one'] = +stakeAmountHigh;
      if (stakeAmountLow !== undefined)
        updateData['reward.stake.stake_two'] = +stakeAmountLow;
